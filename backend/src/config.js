...
const namePrefix = "TestGkollekcio";
const description = "Test g kollekcio";
...
const CONTRACT_NAME = 'TestGkollekcio';
const CONTRACT_SYMBOL = 'TGK';
...
const GENERIC_DESCRIPTION = "Test g kollekcio fedve"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreiff34nuam3rudrds46tl4l6kxyyoso2sq5w33z73v4pmli3djxjcu"; // Replace with your generic image that will display for all NFTs pre-reveal.
